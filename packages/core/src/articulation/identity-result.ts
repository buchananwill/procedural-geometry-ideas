import type { ArticulationChain, StrategyId, StrategyResult } from './types';
 ...
 */
export function identityResult(chain: ArticulationChain, appliedStrategyId: StrategyId): StrategyResult {
    return {
